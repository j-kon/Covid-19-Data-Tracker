...
class _CountryStatWidgetState extends State<CountryStatWidget>
  ...
  void initState() {
    ...
    todayJson = {
      'total_active': widget.totalCases ?? 100,
      'total_cases': widget.totalCases ?? 100,
      'total_recovered': widget.totalRecovered ?? 100,
      'total_death': widget.totalDeath ?? 100,
    };
  }
