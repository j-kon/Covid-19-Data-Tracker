...
class _GlobalCaseContainerState extends State<GlobalCaseContainer> {
  ...
  void updateRadialDial() {
    if (_caseType == CaseType.ACTIVE) {
      ...
      progress = (widget.globalData["totalActiveCases"] + 0.0) /
          widget.globalData["totalConfirmedCases"];
      ...
      progress = (widget.globalData["death"] + 0.0) /
          widget.globalData["totalConfirmedCases"];
      ...
      progress = (widget.globalData["discharged"] + 0.0) /
          widget.globalData["totalConfirmedCases"];
    }
  }
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SmallGraphPanel(
                          label: "Confirmed",
                          value: widget.globalData["totalConfirmedCases"] + 0.0,
                        ...
                        SmallGraphPanel(
                          ...
                          value: _caseType == CaseType.ACTIVE
                              ? widget.globalData["totalActiveCases"] + 0.0
                              : _caseType == CaseType.DEATHS
                                  ? widget.globalData["death"] + 0.0
                                  : widget.globalData["discharged"] + 0.0,
                          icon: Icons.arrow_drop_up,
                          fontColor: panelFontClr,
                          iconColor: panelIconClr,
                          startColor: panelStartClr,
                        ...
                        SmallGraphPanel(
                          label: _caseType == CaseType.RECOVERED
                              ...
                              : "Today",
                          value: _caseType == CaseType.ACTIVE
                              ? widget.globalData["totalConfirmedCases"] + 0.0
                              : _caseType == CaseType.DEATHS
                                  ? widget.globalData["totalConfirmedCases"] +
                                      0.0
                                  : widget.globalData["totalConfirmedCases"] +
